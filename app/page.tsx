...
export default function Page() {
  return (
    <section>
      ...
      <p>
        My interests include <b>deep learning</b>, <b>LLM</b>, <b>cloud computing</b>, <b>computer vision</b> with a focus on practical applications. I have contributed to academic publications and projects in <b>deep learning</b>, driven by a passion for innovation and the intersection of technology and efficiency. I am continually seeking new opportunities to apply my expertise to solve complex challenges.
      </p>
      <div className="my-8">
        {/* <div className="font-semibold text-2xl mb-8 tracking-tighter">My Notes</div>
        <BlogPosts /> */}
